...
## Aufgabe
Implementiert die deutsche Kennzeichen-Validierung von Tag 1 erneut – diesmal aber streng **Test-Driven**!

## Ablauf (30 Minuten)
1. **Vorbereitung**: Erstellt die Testdatei `tests/test_kennzeichen.py`.
2. **Schritt 1 (Red)**: Schreibt den ersten, scheiternden pytest-Test für einen Randfall.
3. **Schritt 2 (Green)**: Ruft den `/tdd`-Skill in OpenCode auf. Der Agent liest den Test, schreibt minimalen Code, um ihn zu bestehen, und führt den Test aus.
